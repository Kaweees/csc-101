...
# Task 1 solution:
world   = objects.World("Fantasy", "Asgard", 1000)
monster = objects.Monster("Frost Giant", "Arctic Blue", 100)
hero  = objects.Hero("Thor", "Hammer", objects.Item("Mjolnir", 100))

# Task 2 solution:
world   = objects.World("Fantasy", "Asgard", 1992)
monster = objects.Monster("Frost Giant", "Arctic Blue", 100)
hero  = objects.Hero("Thor", "traveling", objects.Item("mochi", 300))
...
if (world.setting == "Sci-Fi"):
  print("Welcome to planet Mars in the year:", word.year)
...
if (hero.skill == "farming"):
  ...
  print(hero.name, "was a star athelete.")
...
print(f"So the Wizard did just that and the enchantment created a {hero.item.type}!")
